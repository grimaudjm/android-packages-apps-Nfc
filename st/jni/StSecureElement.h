...
class StSecureElement {
 ...
 private:
  ...
  /* NCI 2.0 - End */
  static const uint16_t DEFAULT_TX_WAITING_TIME = 5000;
...
// WA for eSE: Minimum time enforced between several card activation /
// deactivation
#define ST_ESE_GUARD_TIME 250
  struct timespec mLastCardActivSw;
