...
jint JNI_OnLoad(JavaVM* jvm, void*) {
  ...
  if (android::register_com_android_nfc_stNativeNfcManager(e) == -1)
    return JNI_ERR;
  ...
  if (android::register_com_android_nfc_NativeP2pDevice(e) == -1)
    return JNI_ERR;
  if (android::register_com_android_nfc_stNativeNfcSecureElement(e) == -1)
    return JNI_ERR;
  if (android::register_com_android_nfc_NativeNfcStExtensions(e) == -1)
    return JNI_ERR;
  if (android::register_com_android_nfc_NativeNfcStDtaExtensions(e) == -1)
    return JNI_ERR;
